...
public class RecommendationController {
	...
	public ResponseEntity<?> getAllUser() {
		...
		Iterable<User> users = recommendationService.listAllUser();
...
//	}
	...
	public ResponseEntity<User> deleteUserUsingId(User user) throws Exception {
	...
	public ResponseEntity<List<Category>> userFavCategory(User user, @PathVariable("id") String id) throws Exception {
