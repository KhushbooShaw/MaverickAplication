...
public class RecommendationController {
	...
	@GetMapping("/user/{id}")
	public ResponseEntity<LocalUser> findUserById(@PathVariable("id") String id) throws Exception {
...
//		}
	...
	// @PutMapping("/user/{id}")
	// public ResponseEntity<LocalUser> updateUserUsingId(@RequestBody LocalUser
	// user, @PathVariable("id") String id)
	// throws Exception {
	//
	// if (recommendationService.checkUserId(Long.parseLong(id))) {
	// user.setId(Long.parseLong(id));
	...
	// public ResponseEntity<LocalUser> deleteUserUsingId(LocalUser user) throws
	// Exception {
	//
	// if (recommendationService.checkUserId(user.getId())) {
	//
	...
	// }
	//
	// @GetMapping("/userFavCategory/{id}")
	// public ResponseEntity<List<Category>> userFavCategory(LocalUser user,
	...
	// recommendationService.userFavCategory(Long.parseLong(id));
	//
	// if (topics.size() != 0)
	//
	// {
	...
	//
	// } else {
	// throw new Exception("user with id " + id + " does not have any fav
	// category");
	// }
	// } else {
	// throw new Exception("user with id " + id + " does not exist");
	...
	//
	// @GetMapping("/topic/{id}")
	// public ResponseEntity<Topics> findGameById(Topics game, @PathVariable("id")
	...
	// public ResponseEntity<Topics> addGame(@RequestBody Topics game) throws
	// Exception {
	//
	...
	// public ResponseEntity<Topics> updateGameUsingId(@RequestBody Topics game,
	...
	//
	 ...
	 public ResponseEntity<List<Topics>> findTopicsInCategory(Category category,
	@PathVariable("id") String id)
	 throws Exception {
