...
public interface AdaptiveUserRepository extends Neo4jRepository<AdaptiveUser, Long>{
	...
	@Query("match (n:AdaptiveUser),(m:AdaptiveTopic)-[r:adaptive_topic_of]->(o:AdaptiveCategory) where n.user_id={user_id} and m.topic_id={topic_id} and o.category_id={category_id} create (n)-[r:adaptive_user_played_topic]->(m) return n;")
	...
	@Query("match (nn:AdaptiveUser),(n1:AdaptiveOption)-[rr:adaptive_option_of]->(n:AdaptiveQuestion)-[r1:adaptive_question_of]->(u:AdaptiveLevel1)-[r:adaptive_level_of]->(m:AdaptiveTopic)-[r2:adaptive_topic_of]->(o:AdaptiveCategory) where o.category_id={category_id} and m.topic_id={topic_id} and n.questionId={questionId} and n1.option_id={option_id} and nn.user_id={user_id} create (nn)-[:adaptive_user_answered]->(n1) return nn;")
	...
	@Query("match (nn:AdaptiveUser),(n1:AdaptiveOption)-[rr:adaptive_option_of]->(n:AdaptiveQuestion)-[r1:adaptive_question_of]->(u:AdaptiveLevel2)-[r:adaptive_level_of]->(m:AdaptiveTopic)-[r2:adaptive_topic_of]->(o:AdaptiveCategory) where o.category_id={category_id} and m.topic_id={topic_id} and n.questionId={questionId} and n1.option_id={option_id} and nn.user_id={user_id} create (nn)-[:adaptive_user_answered]->(n1) return nn;")
	...
	@Query("match (nn:AdaptiveUser),(n1:AdaptiveOption)-[rr:adaptive_option_of]->(n:AdaptiveQuestion)-[r1:adaptive_question_of]->(u:AdaptiveLevel3)-[r:adaptive_level_of]->(m:AdaptiveTopic)-[r2:adaptive_topic_of]->(o:AdaptiveCategory) where o.category_id={category_id} and m.topic_id={topic_id} and n.questionId={questionId} and n1.option_id={option_id} and nn.user_id={user_id} create (nn)-[:adaptive_user_answered]->(n1) return nn;")
