...
//	
    ...
    public void processEvent(Game game) {
		...
		//gameRepository.addGame(game.getGameId(),game.getGameName(),game.getCategoryId(),game.getGameType().getGameTypeId(),game.getGameType().getGameTypeName(),game.getGameRules(),game.getGameDescription(),game.getTopic().getTopicId(),new Date());
