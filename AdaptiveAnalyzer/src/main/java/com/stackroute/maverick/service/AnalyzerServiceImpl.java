...
public class AnalyzerServiceImpl implements AnalyzerService {
	...
	Logger log = LoggerFactory.getLogger(AnalyzerServiceImpl.class);

	@Autowired
	public AnalyzerServiceImpl(UserRepository productRepository, CategoryRepository categoryRepository,
